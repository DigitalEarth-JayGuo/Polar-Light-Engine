...
#if PLOperat_System != PLOperatSystem_Unix
	#define PLENGINESYSDATAMACROUNIX_H_
#endif
#ifndef PLENGINESYSDATAMACROUNIX_H_
#define PLENGINESYSDATAMACROUNIX_H_
...
#pragma pack()
#endif /* PLENGINESYSDATAMACROUNIX_H_ */
